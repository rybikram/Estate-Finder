...
export const getListings = async (req, res, next) =>{
   try {
      ...
      if(offer === undefined || offer === 'false') {
         offer = {$in: [false, true]}                  //searching from database offer or non-offer both will be shown
      }
    ...
    const listings = await Listing.find({
        name: {$regex: searchTerm, $options: 'i'},           //here regex is built in mongodb features will search by the key workd adn 'i' will search all basis lower and upper case
        offer,
        furnished,
        parking,
        type,  
