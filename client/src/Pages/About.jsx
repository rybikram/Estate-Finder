...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      text-slate-800'>About Estate Finder</h1>
      ...
      goals by providing expert advice, personalized service, 
      ...
      to our clients. We believe that buying or selling a property 
      should be an exciting and rewarding experience, and 
      we are dedicated to making that a reality for each and 
