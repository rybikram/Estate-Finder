        ...
        {/* top************************ */}
         ...
         max-w-6xl mx-auto'>
            ...
            <div className='text-gray-400 text-xs sm:text-sm'>
               Estate finder is the best place to find your next
               perfect to live.
               <br />
                  ...
                  offerListings && offerListings.length > 0 && (
                    <div className=''>
                      ...
                      <div className='' >
                         ...
                         hover:underline my-3' to={'/search?offer=true'}>
                          Show more offers
                         </Link>
                      </div>
                  ...
                  rentListings && rentListings.length > 0 && (
                    <div className=''>
                      ...
                      <div className='' >
                         ...
                         <Link className='text-sm text-blue-800
                         hover:underline my-3' to={'/search?type=rent'}>
                  ...
                  saleListings && saleListings.length > 0 && (
                    <div className=''>
                      ...
                      <div className='' >
                         ...
                         <Link className='text-sm text-blue-800
                         hover:underline my-3' to={'/search?type=sale'}>
